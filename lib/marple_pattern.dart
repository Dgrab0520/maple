...
import 'package:maple/marple_label.dart';

import 'marple_clothes.dart';

class MarplePattern extends StatefulWidget {
  const MarplePattern({Key? key}) : super(key: key);

  @override
  _MarplePatternState createState() => _MarplePatternState();
}

class _MarplePatternState extends State<MarplePattern> {
  @override
