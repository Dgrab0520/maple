...
import 'package:maple/main_page.dart';

import 'marple_clothes.dart';

class MarpleCPrinting extends StatefulWidget {
  const MarpleCPrinting({Key? key}) : super(key: key);

  @override
  _MarpleCPrintingState createState() => _MarpleCPrintingState();
}

class _MarpleCPrintingState extends State<MarpleCPrinting> {
  @override
