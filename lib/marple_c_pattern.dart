...
import 'package:maple/marple_c_label.dart';

import 'marple_clothes.dart';

class MarpleCPattern extends StatefulWidget {
  const MarpleCPattern({Key? key}) : super(key: key);

  @override
  _MarpleCPatternState createState() => _MarpleCPatternState();
}

class _MarpleCPatternState extends State<MarpleCPattern> {
  @override
