...
import 'package:maple/marple_pattern.dart';

import 'marple_clothes.dart';

class MarpleDesign extends StatefulWidget {
  const MarpleDesign({Key? key}) : super(key: key);

  @override
  _MarpleDesignState createState() => _MarpleDesignState();
}

class _MarpleDesignState extends State<MarpleDesign> {
  @override
